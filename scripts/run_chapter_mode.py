"""
Run TRACE in chapter mode (fastest, single-chapter retrieval).
"""
...
async def main():
    parser = argparse.ArgumentParser(description="Run TRACE in chapter mode")
    ...
    raw_log_dir = os.path.join(os.path.dirname(args.output_file), "raw_logs")
    ...
    for sample in tqdm(data, desc="Processing samples"):
        # Extract chapter name from sample ID
