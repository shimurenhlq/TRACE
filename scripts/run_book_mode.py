"""
Run TRACE in book mode (balanced, book-level retrieval).
"""
...
async def main():
    parser = argparse.ArgumentParser(description="Run TRACE in book mode")
    ...
    raw_log_dir = os.path.join(os.path.dirname(args.output_file), "raw_logs_book")
    ...
    for sample in data:
        ...
        if book_name:
            ...
            print(f"Warning: Book not found for chapter {doc_id}")
